...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(" joão-Conteudos Incritos: " + joao.getConteudosInscritos());
		joao.progredir();
		System.out.println("----------------------");
		System.out.println(" joão-Conteudos Incritos: " + joao.getConteudosInscritos());
		System.out.println(" joão-Conteudos Concluidos: " + joao.getConteudosConcluidos());
		System.out.println(" joão-XP: " + joao.CalcularTotalXp());
		System.out.println("\n ------------------------------------------------------------------------------------------\n");
